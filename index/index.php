        ...
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
                    ...
                    <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                        ...
                        <div x-data="{ isActive: false, open: false }">
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a href="pages/crud_kategori/create_kategori.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    Buat Data Kategori
                                </a>
                                <a href="pages/crud_kategori/view_kategori.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    Lihat Data Kategori
                                </a>
                            </div>
                        </div>
                        ...
                        <div x-data="{ isActive: false, open: false }">
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Pages">
                                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a href="pages/crud_barang/create_barang.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    Buat Data Barang
                                </a>
                                <a href="pages/crud_barang/view_barang.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    Lihat Data Barang
                                </a>
                            </div>
                        </div>
                        ...
                        <div x-data="{ isActive: false, open: false}">
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a href="pages/crud_users/create_user.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
                                    Buat Data User
                                </a>
                                <a href="pages/crud_users/view_user.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
                                    Lihat Data User
                                </a>
                            </div>
                        </div>
                        <div x-data="{ isActive: false, open: false}">
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Layouts">
                                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a href="pages/laporan/" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    Laporan Penjualan
                                </a>
                            </div>
                        </div>
            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                ...
                <main>
                    ...
                    <div class="flex flex-col p-2 space-y-4 antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
                        <main>
                            <div class="space-y-6 bg-white rounded-md dark:bg-darker" style="padding: 25px 25px">
                                <h1 class="font-bold" style="font-size: 2.25rem;">Welcome <?= $_SESSION['nama_lengkap']; ?></h1>
                            </div>
                        </main>
                    </div>
                </main>
