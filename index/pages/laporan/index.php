            ...
            <aside class="flex-shrink-0 hidden w-64 bg-white border-r dark:border-primary-darker dark:bg-darker md:block">
                <div class="flex flex-col h-full">
                    ...
                    <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                        ...
                        <div x-data="{ isActive: false, open: false}">
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                                ...
                                <a href="../crud_users/view_user.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    Lihat Data User
                                </a>
                            </div>
                        </div>
                        <div x-data="{ isActive: true, open: true}">
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Layouts">
                                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700">
                                    Laporan Penjualan
                                </a>
                            </div>
                        </div>
                    ...
                    <footer class="items-center justify-between p-4 bg-white border-t dark:bg-darker dark:border-primary-darker">
                        ...
                        <p>Made by <a href="https://github.com/Kamona-WD" target="_blank" class="text-blue-500 hover:underline">Ahmed Kamel</a></p>
                    </footer>
                </div>
            </aside>
                    ...
                    <div class="bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }" style="margin-left: 20px; margin-right: 20px; margin-top: 50px;">
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            ...
                            <table class="w-full text-lg text-left text-gray-500 dark:text-gray-400" style="margin-left: 24px;">
                                ...
                                $query = "SELECT SUM(tbl_penjualan_item.jumlah) AS qty, tbl_penjualan_item.id_barang, tbl_barang.nama_barang, tbl_barang.stok, tbl_barang.harga_jual
