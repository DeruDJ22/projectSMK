    ...
    <div x-data="setup()" x-init="$refs.loading.classList.add('hidden'); setColors(color);" :class="{ 'dark': isDark}">
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                ...
                <main>
                    <!-- Content header -->
                    <div class="bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }" style="margin-left: 20px; margin-right: 20px; margin-top: 50px;">
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <!-- Card header -->
                            <table class="w-full text-lg text-left text-gray-500 dark:text-gray-400" style="margin-left: 24px;">
                                <thead>
                                    <tr>
                                        <td>No</td>
                                        <td>Nama Barang</td>
                                ...
                                $no = 1;
                                $query = "SELECT tbl_barang.id, tbl_barang.nama_barang, tbl_kategori.nama_kategori, tbl_barang.harga_beli, tbl_barang.harga_jual, tbl_barang.diskon, tbl_barang.stok
                                FROM tbl_barang
                                INNER JOIN tbl_kategori ON tbl_barang.id_kategori=tbl_kategori.id";
                                ...
                                ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex">
                                                    <a href="edit_barang.php?id=<?= $data['id']; ?>" class="btn btn-outline-light">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 20px; margin-right: 10px;">
                                                            <path d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.8 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z" />
                                                        </svg>
                                                    </a>
                                                    <a href="hapus_barang.php?id=<?= $data['id']; ?>" class="btn btn-outline-light">
