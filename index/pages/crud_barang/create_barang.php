                        ...
                        <div class="flex flex-col p-4 space-y-4 antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light" style="margin-top: 30px;">
                            <main>
                                <div class="space-y-6 bg-white rounded-md dark:bg-darker" style="padding: 50px 50px;">
                                    ...
                                    <form action="insert_barang.php" method="post" class="space-y-6">
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="text" name="nama" placeholder="Nama Barang" required style="padding: 12px 20px; width: 100%;" />
                                        ...
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="number" name="beli" placeholder="Harga Beli" required style="padding: 12px 20px; width: 100%;" />
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="number" name="jual" placeholder="Harga Jual" required style="padding: 12px 20px; width: 100%;" />
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="number" name="diskon" placeholder="Diskon" required style="padding: 12px 20px; width: 100%;" />
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="number" name="stok" placeholder="Stok" required style="padding: 12px 20px; width: 100%;" />
                                        <div>
