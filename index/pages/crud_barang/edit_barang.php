                    ...
                    <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                        ...
                        <div x-data="{ isActive: true, open: true }">
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Pages">
                                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a href="create_barang.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    Buat Data Barang
                                </a>
                                <a href="view_barang.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    Lihat Data Barang
                                </a>
                            </div>
                        </div>
                        ...
                        <div x-data="{ isActive: false, open: false}">
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a href="../crud_users/create_user.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
                                    Buat Data User
                                </a>
                                <a href="../crud_users/view_user.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
                                    Lihat Data User
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col p-4 space-y-4 antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light" style="margin-top: 30px;">
                            <main>
                                <div class="space-y-6 bg-white rounded-md dark:bg-darker" style="padding: 50px 50px;">
                                    <h1 class="text-xl font-bold text-center">Buat Data Barang</h1>
                                    <form action="update_barang.php" method="post" class="space-y-6">
                                        <input type="hidden" name="id" value="<?= $data['id']; ?>">
                                        <input type="hidden" name="namalama" value="<?= $data['nama_barang']; ?>">
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="text" name="nama" placeholder="Nama Barang" required style="padding: 12px 20px; width: 100%;" value="<?= $data['nama_barang']; ?>" />
                                        <select name="barang" class="form-select border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" style="padding: 10px 20px; width: 100%;">
                                            <?php
                                        ...
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="number" name="beli" placeholder="Harga Beli" required style="padding: 12px 20px; width: 100%;" value="<?= $data['harga_beli']; ?>" />
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="number" name="jual" placeholder="Harga Jual" required style="padding: 12px 20px; width: 100%;" value="<?= $data['harga_jual']; ?>" />
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="number" name="diskon" placeholder="Diskon" required style="padding: 12px 20px; width: 100%;" value="<?= $data['diskon']; ?>" />
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="number" name="stok" placeholder="Stok" required style="padding: 12px 20px; width: 100%;" value="<?= $data['stok']; ?>" />
                                        <div>
