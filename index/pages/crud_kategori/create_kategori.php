                    ...
                    <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                        ...
                        <div x-data="{ isActive: false, open: false}">
                            ...
                            <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Dashboards">
                                ...
                                <a href="../../" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700s">
                                    Home
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col p-4 space-y-4 antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light" style="margin-top: 150px;">
                            <main>
                                <div class="space-y-6 bg-white rounded-md dark:bg-darker" style="padding: 50px 50px;">
                                    <h1 class="text-xl font-bold text-center">Buat Data Kategori</h1>
                                    <form action="insert_kategori.php" method="post" class="space-y-6">
                                        <input class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="text" name="nama" placeholder="Nama Kategori" required style="padding: 12px 20px; width: 100%;" />
