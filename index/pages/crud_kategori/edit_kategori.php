                    ...
                    <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                        ...
                        <div x-data="{ isActive: true, open: true }">
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a href="create_kategori.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    Buat Data Kategori
                                </a>
                                <a href="view_kategori.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    Lihat Data Kategori
                                </a>
                            </div>
                        </div>
            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                ...
                <main>
                    ...
                    <div class="bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                        <!-- Card header -->
                        <div class="flex flex-col p-4 space-y-4 antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light" style="margin-top: 150px;">
                            <main>
                                <div class="space-y-6 bg-white rounded-md dark:bg-darker" style="padding: 50px 50px;">
                                    <h1 class="text-xl font-bold text-center">Edit Kategori</h1>
                                    <form action="update_kategori.php" method="post" class="space-y-6">
                                        <input type="hidden" name="id" value="<?= $data['id']; ?>">
                                        <input type="hidden" name="namalama" value="<?= $data['nama_kategori']; ?>">
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="text" name="nama" placeholder="Nama Kategori" required style="padding: 12px 20px; width: 100%;" value="<?= $data['nama_kategori']; ?>" />
