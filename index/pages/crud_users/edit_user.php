                    ...
                    <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                        ...
                        <div x-data="{ isActive: true, open: true}">
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a href="create_user.php" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
                                    Buat Data User
                                </a>
                            ...
                            <main>
                                <div class="space-y-6 bg-white rounded-md dark:bg-darker" style="padding: 50px 50px;">
                                    ...
                                    <form action="update_user.php" method="post" class="space-y-6">
                                        ...
                                        <input type="hidden" name="userlama" value="<?= $data['username']; ?>">
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="text" name="username" placeholder="Username" required style="padding: 12px 20px; width: 100%;" value="<?= $data['username']; ?>" />
                                        ...
                                        <input type="hidden" name="namalama" value="<?= $data['nama_lengkap']; ?>">
                                        <input class="border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="text" name="nama" placeholder="Nama Lengkap" required style="padding: 12px 20px; width: 100%;" value="<?= $data['nama_lengkap']; ?>" />
