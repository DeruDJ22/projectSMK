                ...
                <div class="card bg-dark text-white bg-opacity-75" style="border-radius: 24px;">
                    <div class="card-body p-5">
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <h2 class="text-uppercase fw-bold mb-5 text-center">Register</h2>
                            <form action="buat.php" method="post">
                                ...
                                <div class="form-floating form-outline form-light mb-4">
                                    <input type="password" name="pass" class="form-control" id="floatingInput" placeholder="pass">
                                ...
                                <div class="form-floating form-outline form-light mb-4">
                                    ...
                                    <label for="floatingInput" style="color: #000000; text-align: left;">Nama Lengkap</label>
                                </div>
                                <div class="bg-white text-black mb-4 form-control">
                                    <label class="form-label">Level</label> <br>
                                    <input type="radio" name="level" value="admin" class="form-class-input">Admin <br>
                                    <input type="radio" name="level" value="kasir" class="form-class-input">Kasir
                                </div>
                                <center>
                                    <button class="btn btn-outline-light btn-lg px-5" type="submit" name="login">Kirim</button>
                                </center>
                            </form>
                            <form>
